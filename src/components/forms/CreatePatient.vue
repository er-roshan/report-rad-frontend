      ...
      <div>
        ...
        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <div class="mt-1">
              <input v-model="form_data.full_name" type="text" name="full-name" id="full-name" autocomplete="given-name"
                class="report-input" />
            </div>
          </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-1">
              <input id="email" name="email" type="email" autocomplete="email" class="report-input" />
            </div>
          </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-1">
              <input v-model="form_data.phone_number" type="text" name="phone" id="phone" autocomplete="phone"
                class="report-input" />
            </div>
          </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-1 flex justify-center gap-x-2">
              <input v-model="form_data.age_value" id="age_value" name="age_value" type="text" class="report-input" />

              <select v-model="form_data.age_unit" id="age-unit" name="age-unit" 
                class="report-input">
              ...
              <select v-model="form_data.age_type" id="age-type" name="age-type"
                class="report-input">
              ...
              <fieldset class="mt-2">
                ...
                <div class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                  <div class="flex items-center">
                    <input value="male" v-model="form_data.sex" id="email" name="notification-method" type="radio" checked
                      class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    <label for="email" class="ml-3 block text-sm font-medium text-gray-700">Male</label>
                  </div>

                  <div class="flex items-center">
                    <input value="female" v-model="form_data.sex" id="sms" name="notification-method" type="radio"
                      class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
                    <label for="sms" class="ml-3 block text-sm font-medium text-gray-700">Female</label>
                  </div>

                  <div class="flex items-center">
                    <input value="others" v-model="form_data.sex" id="push" name="notification-method" type="radio"
                      class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-1">
              <input v-model="form_data.refer_by" type="text" name="refer-by" id="refer-by" autocomplete="address-level2" class="report-input" />
            </div>
          </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-1">
              <input v-model="form_data.investigation" type="text" name="region" id="region" autocomplete="address-level1" class="report-input" />
            </div>
          </div>
